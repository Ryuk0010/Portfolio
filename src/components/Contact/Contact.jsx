        ...
        <section id="contact" className={dark ? 'dark-mode' : ''}>
            ...
            <div className="contact-info">
                <div className="info-box">
                    ...
                    <p style={{ color: dark ? '#F1EFE2' : 'black' }}>Basirhat<br />24 Parganas(N), West Bengal<br />743292, India</p>
                </div>
                <div className="info-box">
                    <div className="icon">
                    ...
                    <p style={{ color: dark ? '#F1EFE2' : 'black' }}>mousambachhar2019@gmail.com</p>
                    <p style={{ color: dark ? '#F1EFE2' : 'black' }}>iammousambachhar@gmail.com</p>
                </div>
                <div className="info-box">
                    <div className="icon">
                    ...
                    <p style={{ color: dark ? '#F1EFE2' : 'black' }}>Phone: +91 7557072946</p>
                </div>
            </div>
        </section>
    );
